...
export default async function DashboardHome() {
  ...
  // Urgent renewals (due in 7 days or lapsed)
  ...
  // Open high-priority claims/alerts
  allAlerts.forEach(a => {
    ...
    if (isHighPriority || isClaim) {
      feed.push({
        id: `alert-${a.id}`,
        urgency: 100 + daysAgo, // after urgent renewals
  ...
  return (
    <div style={{ padding: '32px 40px', maxWidth: 900, margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16, marginBottom: 32 }}>
        {[
          { label: 'Clients', value: clientCount || 0, sub: 'total', href: '/dashboard/clients' },
          { label: 'Annual premium', value: `$${totalPremium.toLocaleString()}`, sub: 'across all policies', href: '/dashboard/analytics' },
