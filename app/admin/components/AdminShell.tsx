...
export default function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  if (isMobile) {
    return (
      <div style={{ minHeight: "100vh", background: "#0D0603", display: "flex", flexDirection: "column" }}>
        {/* Mobile top bar */}
        <header
          style={{
            background: "#080402",
        ...
        >
          <Link href="/admin" style={{ textDecoration: "none", display: "block", marginBottom: 10 }}>
            <div style={{ fontFamily: "Cormorant Garamond, serif", fontSize: 22, color: "#F5ECD7" }}>
              espresso<span style={{ color: "#C8813A" }}>.</span>
              <span style={{ fontFamily: "DM Sans, sans-serif", fontSize: 10, color: "#C8813A", letterSpacing: "0.1em", textTransform: "uppercase", marginLeft: 8 }}>
                Admin
              </span>
            </div>
          </Link>
